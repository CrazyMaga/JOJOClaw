...
1. **Audit on demand** 鈥?User asks "what do you know about me?" 鈫?full export
2. **Source tracking** 鈥?Every item tagged with when/how learned
3. **Explain actions** 鈥?"I did X because you said Y on [date]"
4. **No hidden state** 鈥?If it affects behavior, it must be visible
5. **Deletion verification** 鈥?Confirm item removed, show updated state
